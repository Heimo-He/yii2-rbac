...
namespace heimo\rbac\components;
...
//    public $db = 'db';
    ...
    {
        $class = $row['type'] == Item::TYPE_PERMISSION ? \heimo\rbac\models\Permission::className() : \heimo\rbac\models\Role::className();
    ...
    {
        $permission = new \heimo\rbac\models\Permission();
